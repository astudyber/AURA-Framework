...
def process_folder(input_folder, output_folder, model_path):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith("Gaussian_Noise.png"):
            input_path = os.path.join(input_folder, filename)
            output_path = os.path.join(output_folder, "clear.png")
            test_image(model, input_path, output_path)

if __name__ == "__main__":
    model_path = "./Experiment/Denoise/model.pth"  # Replace with your weight file path
    input_folder = "./Experiment/Denoise"  # Replace with your input folder path
    output_folder = "./Experiment/Denoise"  # Replace with your output folder path
